...
public class LabelTranslatorSingleton {
    ...
    private void Turkish() {
         ...
         _addTranslation("Note: enable it in order to mitigate bandwidth limit. (Multi slot required).", "Not: Hız sınırını azaltmak için etkinleştirin.(Çoklu indirme modunun aktif olması gerekir.)");
         ...
         _addTranslation("Open folder in browser", "Klasörü Trayıcıda Aç");
