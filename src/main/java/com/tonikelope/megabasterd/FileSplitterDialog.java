...
public class FileSplitterDialog extends javax.swing.JDialog {
    ...
    private List<Path> _splitFile() throws IOException {
    ...
    private void _writePartToFile(long byteSize, long position, FileChannel sourceChannel, List<Path> partFiles, int conta_split) throws IOException {
